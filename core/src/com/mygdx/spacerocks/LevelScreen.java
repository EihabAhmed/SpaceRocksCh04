...
public class LevelScreen extends BaseScreen {
    ...
    public void update(float dt) {
        for (BaseActor rockActor : BaseActor.getList(mainStage, "com.mygdx.spacerocks.Rock")) {
            ...
            for ( BaseActor laserActor : BaseActor.getList(mainStage, "com.mygdx.spacerocks.Laser") )
            {
